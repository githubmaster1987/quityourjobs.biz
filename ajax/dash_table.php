        ...
        <tbody>
            ...
            while ($getassetrow = mysql_fetch_array($getasset)) {
                ...
                if (($potentialnumber != '6') && ($potentialnumber != '7') && ($potentialnumber != '8')) {
                    ?>
                    <tr>
                        <td><img src="http://quityourjobs.biz/members/images/assetsLogos/<?php echo $getassetrow['id']; ?>.png" alt="USD/JPY"><?php echo $getassetrow['name']; ?></td>
...
<?php } else { ?>
    <div class="makedeposit" style="text-align:center; padding:50px;">
        <img class="img-responsive" src="http://quityourjobs.biz/members/images/loader.gif" style="width:150px; margin-bottom:0px;">
