	...
	require("validation.php");
   	...
   	if(empty($errors)) {
		...
		if(!empty($check)) {
			...
			We\'re sorry you are having trouble logging into your Quit Your Jobs account.<br><br>

			Here is your Password - '.$getuserrow['password'].'<br><br>

			If you continue having problems logging in, you can contact us at support@quityourjobs.biz<br><br>
			...
			// Additional headers
			$headers .= 'From: Quit Your Jobs Member <support@quityourjobs.biz>' . "\r\n";
...
<head>
  ...
  <title>Forget Password | Quit Your Jobs </title>
...
<body class="loginbody background-color: #b1dcfb !important;">
	  ...
	  <input type="hidden" name="login" value="1">
        <div class="row">
          <div class="input-field col s12 center">
            ...
            <p class="center login-form-text" style="color:green;">Quit Your Jobs <br>
          </div>
        </div>
