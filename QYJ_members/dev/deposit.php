...
if (isset($_SESSION['userid'])) {
    ...
    $title = 'Self-made Millionaire System Deposit at ' . $getbrandrow['name'] . ' | ' . $spotid . '| ';
                ...
                <div class="row bg-title bredcrums-menu">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active breadcrumb-active">Deposit</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="section">
                    ...
                    switch ($getbrandrow['api_type']) {
                        ...
                        case "TECH FINANCIALS":
                            ...
                            ?>
                            <form action="<?php echo $getbrandrow['autologin_url'] . $getbrandrow['deposit_url']; ?>" method="post" name="loginNow" id="loginNow" autocomplete="off" target="myFrame">
                                ...
                                <input type="hidden" value="<?php echo $getbrandrow['deposit_url']; ?>" name="r">
                        ...
                        case "SPOT":
                            ...
                            <form action="<?php echo $getbrandrow['autologin_url']; ?>" method="post" name="loginNow" id="loginNow" autocomplete="off" target="myFrame">
                                ...
                                <input type="hidden" name="redirect" value="<?php echo $getbrandrow['deposit_url']; ?>">
                                <input type="hidden" name="extRedir" value="<?php echo $getbrandrow['deposit_url']; ?>">			
                            </form>
							<div class="col-lg-12 col-md-12 col-sm-12 iframe-container">
                        ...
                        case "SPOT-BDB":
                            ...
                            if ($getcbrandrow['reg'] == '1') {
                                $platformurl = 'https://eu.bancdebinary.com/?rs=1&action=enterAccount&goto=' . $getbrandrow['deposit_url'] . '&customerId=' . $customerId . '&uKey=' . $authKey . '&lang=en';
                            } else {
                                $platformurl = 'https://bancdebinary.com/?rs=1&action=enterAccount&goto=' . $getbrandrow['deposit_url'] . '&customerId=' . $customerId . '&uKey=' . $authKey . '&lang=en';
                            }
                        ...
                        case "SPOT-USA":
                            ...
                            echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" style="" scrolling="yes" src="' . $getbrandrow['autologin_url'] . $getuserrow['session_id'] . '&extRedir=' . $getbrandrow['deposit_url'] . '"></iframe></div>';
                            break;
                        ...
                        case "OPTECK":
                            ...
                            $url = $decoded->data->depositPageLink;
                        ...
                        case "MARKETPULSE":
                            ...
                            echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" scrolling="yes" style="" src="' . $getbrandrow['autologin_url'] . $token . '&redirectUrl=' . $getbrandrow['deposit_url'] . '?ShowMessage=True"></iframe></div>';
                            break;

                        case "PANDA":

                            echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" style="" scrolling="yes" src="' . $getbrandrow['autologin_url'] . $getuserrow['email'] . '&password=' . $getuserrow['password'] . '&url=' . $getbrandrow['deposit_url'] . '"></iframe></div>';
                            break;


                        case "TRADOLOGIC":

                            echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" scrolling="yes" style="" src="' . $getbrandrow['deposit_url'] . $getuserrow['session_id'] . '"></iframe></div>';
                            break;

                        case "AIRSOFT":
                            $url = $getbrandrow['autologin_url'] . '&key=' . $getbrandrow['password'] . '&client_id=' . $getuserrow['spotid'] .
                                    '&redirect_url=' . $getbrandrow['deposit_url'];									
                            $curl = curl_init($url);
                            curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, true);
                            curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
                            $result = curl_exec($curl);
                            ...
                            echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" style="" src="' . $url . '" scrolling="yes"></iframe></div>';
                            break;
    ...
    <script type="text/javascript">
        var depositStatus = '<?php echo $getuserrow['deposit_status']; ?>';
    </script>
