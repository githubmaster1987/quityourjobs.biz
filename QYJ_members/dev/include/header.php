...
<head>
    ...
    <link href="css/style-sky-blue.css" rel="stylesheet" id="style_color" />
    ...
    <div class="navbar-header active"> <a data-target=".navbar-collapse" data-toggle="collapse" href="javascript:void(0)" class="navbar-toggle hidden-sm hidden-md hidden-lg "><i class="ti-menu"></i></a>
        <div class="top-left-part">
            <a href="index.php" class="logo custom-logo">
                <b><img alt="home" src="img/logo.png" width="132"></b>
            </a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right in">
            ...
            <li class="dropdown active"> <a href="#" data-toggle="dropdown" class="dropdown-toggle profile-pic active"> <img width="36" class="img-circle" alt="user-img" src="https://selfmademillionaires.biz/members/images/avatar-login.png"><b class="hidden-xs"><?php echo $getuserrow['name']; ?></b> </a>
    ...
    <div role="navigation" class="navbar-default sidebar" style="overflow: inherit;">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar active in" aria-expanded="true" style="">
            <ul id="side-menu" class="nav in">
                ...
                <li> 
                    <a class="waves-effect <?php echo ($page == 'trading-are.php')?"active":""?>" href="trading-are.php">
