...
$getassett=mysql_query("SELECT * FROM `assets`");
$assetcount=mysql_num_rows($getassett);

echo 'TOTAL ASSETS: '.$assetcount;


$getuser = mysql_query("select * from users where `deposit_status`='LIVE' AND `autotrade`='1' ORDER BY `id` DESC")or die(mysql_error());
while($getuserrow=mysql_fetch_array($getuser)){
$asset_id = rand(1,$assetcount);

echo 'ASSET ID:'.$asset_id;

$getasset=mysql_query("SELECT * FROM `assets` WHERE `id`='2'")or die(mysql_error());
...
$amount=$getuserrow['a_amount'];
$brand =$getuserrow['brand'];
...
$getbrand =mysql_query("select * from brands where ref='$brand'");
$getbrandrow=mysql_fetch_array($getbrand);
 

echo $getassetrow['name'].' FOR '.$action.'for Amount of '.$amount.' With Brand '.$brand.'<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
