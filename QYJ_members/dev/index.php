...
if(isset($_SESSION['userid'])){
	...
	$title='Self-made Millionaire System dashboard at '.$getbrandrow['name'];
                ...
                <div class="span4 autotradeform-container">
                    <form name="autotradeform" method="POST" style="margin: 0;">
                        <div class="white-boxes-traders">
                            <h4>Activate Account Tradings</h4>
                            <p>Before you can activate your trading system you must <a href="">Fund Your Account</a></p>
                            ...
                            <p><span class="text-danger">Autotrader will be availabel after completing step2</span></p>
...
$('#main-content, #sidebar').click(function() {
   ...
   {  
      document.location.href = "http://quityourjobs.biz/dev/deposit.php";    
   }
 });
<?php } ?>
