...
if(isset($_SESSION['userid'])){
	...
	$title='Self-made Millionaire System Trading Area at '.$getbrandrow['name'];
...
<div id="main-content" style="margin-left: 0px; margin-bottom: 0px;">
           ...
           <div class="row-fluid">
                <div class="row bg-title bredcrums-menu">
                 <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                     <h4 class="page-title">Trading area</h4>
                 </div>
                 <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                     <ol class="breadcrumb">
                         <li><a href="index.php">Home</a></li>
                         <li class="active breadcrumb-active">Trading area</li>
                     </ol>
                 </div>
                 <!-- /.col-lg-12 -->
             </div>
		...
		switch ($getbrandrow['api_type']) {
		  ...
		  case "SPOT-USA":		
			...
			echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" style="" scrolling="yes" src="'.$getbrandrow['autologin_url'].$getuserrow['session_id'].'&extRedir='.$getbrandrow['tradingfloor_url'].'"></iframe></div>';
	 		break;
		  ...
		  case "MARKETPULSE":
			...
			echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" style="" scrolling="yes" src="'.$getbrandrow['autologin_url'].$token.'&redirectUrl='.$getbrandrow['tradingfloor_url'].'?ShowMessage=True"></iframe></div>';
		        break;

		  case "PANDA":		

			echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" style="" scrolling="yes" src="'.$getbrandrow['autologin_url'].$getuserrow['email'].'&password='.$getuserrow['password'].'&url='.$getbrandrow['tradingfloor_url'].'"></iframe></div>';
	 		break;


		  case "TRADOLOGIC":		

			echo '<div class="col-lg-12 col-md-12 col-sm-12 iframe-container"><iframe id="iframe" name="myFrame" style="" scrolling="yes" src="'.$getbrandrow['tradingfloor_url'].$getuserrow['session_id'].'"></iframe></div>';
	 		break;
