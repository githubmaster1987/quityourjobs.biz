function getRate(asset_id, json_url) {
	...
	if(n != 0 && n != 6) {
		...
		$.getJSON(json_url, function (data) {
			...
			price = data[asset_id]["series"][0]["data"][0][1];
...
window.setInterval(function(){
  //getRate('2', 'http://spotplatform.500option.com/PlatformAjax/getJsonFile/graph/regular/binary/-0minutes/now/asset/2/graphData.spotgraph');
  //getRate('35', 'http://spotplatform.500option.com/PlatformAjax/getJsonFile/graph/regular/binary/-0minutes/now/asset/35/graphData.spotgraph');
  //getRate('46', 'http://spotplatform.500option.com/PlatformAjax/getJsonFile/graph/regular/binary/-0minutes/now/asset/46/graphData.spotgraph');
  //getRate('91', 'http://spotplatform.500option.com/PlatformAjax/getJsonFile/graph/regular/binary/-0minutes/now/asset/91/graphData.spotgraph');
  //getRate('95', 'http://spotplatform.500option.com/PlatformAjax/getJsonFile/graph/regular/binary/-0minutes/now/asset/95/graphData.spotgraph');
  //getRate('157', 'http://spotplatform.500option.com/PlatformAjax/getJsonFile/graph/regular/binary/-0minutes/now/asset/157/graphData.spotgraph');
