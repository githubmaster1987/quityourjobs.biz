...
function sendmail($email,$firstname, $lastname, $password){
	...
	Login Page: <a href="https://selfmademillionaires.biz/members/login.php">https://selfmademillionaires.biz/members/login.php</a><br>
	Email – '.$email.'<br>
	Pass – '.$password.'<br><br>
...
function redirect() {
	echo '<script type="text/javascript">window.top.location.href = "/dev/index.php";</script>';
}
	...
	//echo $url;
		...
		case 'AIRSOFT':
                $service_url = $getbrandrow['api_url'].'?key=' . $getbrandrow['password'] .
                    ...
                    '&comment=https://quityourjobs.biz'.
