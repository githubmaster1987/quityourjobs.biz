...
$(document).ready(function(){
  ...
  $('#register').on('focusout', '#password', function(){
    ...
    if ($(this).val() === '') {
        ...
        $('#password').get(0).setCustomValidity('Must be 6 characters Long  e.g - abc123. No special characters allowed e.g. - @/$%#^*!');
    }
  });
  ...
  $('#register').on('change', '#country_sel', function(){
  var calling_code = $("#country_sel").val();
