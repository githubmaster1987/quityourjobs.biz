...
<head>
  ...
  <title>Login | Quit Your Jobs </title>
  ...
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#F0E68C">
...
#login-page{ margin-right:15%; margin-top: 1%; }
...
#modal3 iframe{height: 180x; overflow:hidden;}

  #modal3 iframe body, #modal2 iframe html{ overflow: hidden !important;}
...
@media screen and (max-width: 722px){
	#modal3 iframe{height: 350px; overflow: hidden;}
	#modal3 iframe body, #modal2 iframe html{ overflow: hidden !important;}
	  ...
	  <input type="hidden" name="login" value="1">
        <div class="row">
          <div class="input-field col s12 center">
            ...
            <p class="center login-form-text" style="font-family: monospace;">Quit Your Jobs Login</p>
          </div>
        </div>
...
<?php } ?>
        ...
        <div class="row">
          <div class="input-field col s12">
            <button onClick='popit=false' href="javascript: document.getElementById('login').submit();" class="btn col s12">Login</button>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s6 m6 l6">
            <p class="margin medium-small"><a onClick="registration()" href="javascript:void();">Register Now!</a></p>
          </div>
          <div class="input-field col s6 m6 l6">
        ...
        <div id="modal3" class="modal">
            ...
            <div id="myModal" class="modal-content">
                <p class="center login-form-text" style="font-family: monospace;">Playboy Millionaires</p>
				<div class="videoiframe-container">
                <iframe id="videoiframe" class="videoiframe" src="f_register_b.php?param=login" frameborder="0" width="100%" scrolling="no" allowfullscreen></iframe>
				</div>
            </div>
        </div>
        <!-------Modal End ----------------->
...
/*(function() 
{
    ...
    function changeBackground()
    {
        ...
        $('body').css('background', '#F0E68C url('+backgrounds[bgCounter]+') repeat-x');
