	...
	$rules[] = "required,password,Please insert your password.";
   	...
   	if(empty($errors)) {
		...
		if(!empty($check)) {
              ...
              //echo "Test2";
			echo "<meta http-equiv=\"Refresh\"content=\"0; URL=loginmaster.php\">";
			exit;	
...
#login-page{ margin-right:15%; margin-top: 15px; }
...
#modal3{width:80% !important; min-height: 180px; top: 25% !important; overflow:hidden;}
	  ...
	  <input type="hidden" name="login" value="1">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="images/login.png" alt="" class="circle responsive-img valign profile-image-login" style="border-radius: 0;">
...
<?php } ?>
       ...
       <!-- <div class="row margin">-->
        ...
        <div id="modal3" class="modal">
            ...
            <div id="myModal" class="modal-content" style="">
                <p class="center login-form-text" style="font-family: monospace;">Quit Your Jobs</p>
				<div class="videoframe-container" style="">
