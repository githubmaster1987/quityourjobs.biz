...
if(isset($_SESSION['userid'])){
	...
	$title='Quit Your Jobs Close Trade at '.$getbrandrow['name'];
            ...
            <tr>
               <td><a href="#"><img src="http://quityourjobs.biz/members/images/assetsLogos/<?php $assetID=$t->assetID; $getassetimage=mysql_query("SELECT * FROM `assets` WHERE `optech_id`='$assetID'")or die(mysql_error()); $getassetimagerow=mysql_fetch_array($getassetimage); echo $getassetimagerow['id']; ?>.png">&nbsp;&nbsp;<?php echo $getassetimagerow['name']; ?></a></td>      
                ...
                <td><?php if($t->direction=='1') { // call
					if($t->strikeEnd > $t->strike){ echo '<span class="label label-info label-mini"><i class="fa fa-thumbs-up"></i> won'; }
                                        if($t->strikeEnd < $t->strike){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost'; }
					...
					if($t->strikeEnd < $t->strike){ echo '<span class="label label-info label-important label-mini"><i class="fa fa-thumbs-up"></i> won'; }
                                        if($t->strikeEnd > $t->strike){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost';  }
...
?>
        	...
        	<td><?php 	 if($p->status=='Win'){ echo '<span class="label label-info label-mini"><i class="fa fa-thumbs-up"></i> won'; }
                       		 elseif($p->status=='Lost'){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost'; }
		...
		foreach($jsonResponse->data as $t) {                       
            ...
            <tr>
                ...
                <td><?php if($t->action == 'Call') { // call
					if($t->expiryRate > $t->rate){ echo '<span class="label label-info label-mini"><i class="fa fa-thumbs-up"></i> won'; }
                                        if($t->expiryRate < $t->rate){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost'; }
                                        if($t->expiryRate == $t->rate){ echo '<span class="label label-success label-mini"><i class="icon-exchange"></i> tie'; }
				}elseif($t->action == 'Put') { // put
					if($t->expiryRate < $t->rate){ echo '<span class="label label-info label-important label-mini"><i class="fa fa-thumbs-up"></i> won'; }
                                        if($t->expiryRate > $t->rate){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost';  }
		...
		foreach($decoded->result as $t) {
            ...
            <tr>
                ...
                <td><?php if($t->tradinghistory_positionType == 49) { // call
					if($t->tradinghistory_closePrice > $t->tradinghistory_strike){ echo '<span class="label label-info label-mini"><i class="fa fa-thumbs-up"></i> won'; }
                                        if($t->tradinghistory_closePrice < $t->tradinghistory_strike){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost'; }
					...
					if($t->tradinghistory_closePrice < $t->tradinghistory_strike){ echo '<span class="label label-info label-important label-mini"><i class="fa fa-thumbs-up"></i> won'; }
                                        if($t->tradinghistory_closePrice > $t->tradinghistory_strike){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost';  }
...
?>
		...
		<td><?php if($p->action =='1') { // call
							if($p->closePrice > $p->targetPrice){ echo '<span class="label label-info label-mini"><i class="fa fa-thumbs-up"></i> won'; }
				                        if($p->closePrice < $p->targetPrice){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost'; }
							...
							if($p->closePrice < $p->targetPrice){ echo '<span class="label label-info label-important label-mini"><i class="fa fa-thumbs-up"></i> won'; }
				                        if($p->closePrice > $p->targetPrice){ echo '<span class="label label-important label-important label-mini"><i class="fa fa-thumbs-down"></i> lost';  }
